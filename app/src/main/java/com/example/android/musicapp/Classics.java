...
public class Classics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        musicLibrary.add(new Music("Emma Shapplin", "Carmine Meo"));
        musicLibrary.add(new Music("Queen", "Bohemian Rhapsody"));
        musicLibrary.add(new Music("The Verve", "Bitter Sweet Symphony"));
